...
def place_order(request,total =0, quantity = 0,):
    ...
    # if the cart count is less than or equal to zero, then redirect to store
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            current_date = d.strftime('%Y%m%d')   #20210805

            order_number = current_date + str(data.id)    #202108051
